...
const raylib = (() => {
    let filename = 'dist/node/raylib_' + process.platform + (process.platform == 'win32' ? '.dll' : '.so');

    let lib = ffi.Library(filename, {
...
const Colors = {
    WHITE: new Color({r: 255, g: 255, b: 255, a: 255}),
    BLACK: new Color({r: 0, g: 0, b: 0, a: 255}),
    BLANK: new Color({r: 0, g: 0, b: 0, a: 0}),
    MAGENTA: new Color({r: 255, g: 0, b: 255, a: 255}),
    RAYWHITE: new Color({r: 245, g: 245, b: 245, a: 255}),
    LIGHTGRAY: new Color({r: 200, g: 200, b: 200, a: 255}),
    GRAY: new Color({r: 130, g: 130, b: 130, a: 255}),
    DARKGRAY: new Color({r: 80, g: 80, b: 80, a: 255}),
    YELLOW: new Color({r: 253, g: 249, b: 0, a: 255}),
    GOLD: new Color({r: 255, g: 203, b: 0, a: 255}),
    ORANGE: new Color({r: 255, g: 161, b: 0, a: 255}),
    PINK: new Color({r: 255, g: 109, b: 194, a: 255}),
    RED: new Color({r: 230, g: 41, b: 55, a: 255}),
    MAROON: new Color({r: 190, g: 33, b: 55, a: 255}),
    GREEN: new Color({r: 0, g: 228, b: 48, a: 255}),
    LIME: new Color({r: 0, g: 158, b: 47, a: 255}),
    DARKGREEN: new Color({r: 0, g: 117, b: 44, a: 255}),
    SKYBLUE: new Color({r: 102, g: 191, b: 255, a: 255}),
    BLUE: new Color({r: 0, g: 121, b: 241, a: 255}),
    DARKBLUE: new Color({r: 0, g: 82, b: 172, a: 255}),
    PURPLE: new Color({r: 200, g: 122, b: 255, a: 255}),
    VIOLET: new Color({r: 135, g: 60, b: 190, a: 255}),
    DARKPURPLE: new Color({r: 112, g: 31, b: 126, a: 255}),
    BEIGE: new Color({r: 211, g: 176, b: 131, a: 255}),
    BROWN: new Color({r: 127, g: 106, b: 79, a: 255}),
    DARKBROWN: new Color({r: 76, g: 63, b: 47, a: 255})
};
...
exports.run_window = function(title, params, func) {
    let background = (params.background != null) ? raylib[params.background.toUpperCase()] : Colors.WHITE;
...
exports.is_fullscreen = function() {
    return raylib.IsWindowState(raylib.FLAG_WINDOW_UNDECORATED);
};
...
exports.set_fullscreen = function(fullscreen) {
    ...
    let windowed = StateFlags.FLAG_WINDOW_RESIZABLE;
...
exports.draw_text = function(x, y, params, text) {
    ...
    raylib.DrawTextEx(default_font, text, new Vector2({x: dx, y: dy}), size, 1, color);
    raylib.rlPopMatrix();
...
exports.draw_rectangle = function(x, y, width, height, params) {
    ...
    let rect = new Rectangle({x: dx, y: dy, width: width, height: height});
